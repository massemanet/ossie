...
-define(SGSAP_MSGT_LOCATION_UPDATE_ACCEPT, 2#00001010).
-define(SGSAP_MSGT_LOCATION_UPDATE_REJECT, 2#00001011).
-define(SGSAP_MSGT_TMSI_REALLOCATION_COMPLETE, 2#00001100).
-define(SGSAP_MSGT_ALERT_REQUEST, 2#00001101).
-define(SGSAP_MSGT_ALERT_ACK, 2#00001110).
-define(SGSAP_MSGT_ALERT_REJECT, 2#00001111).
-define(SGSAP_MSGT_UE_ACTIVITY_INDICATION, 2#00010000).
-define(SGSAP_MSGT_EPS_DETACH_INDICATION, 2#00010001).
...
%% 2#00011001 % Unassigned: treated as an unknown Message type
