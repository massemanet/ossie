...
-define(SCCP_MSG_BIN, <<9,0,3,13,24,10,18,7,0,18,4,83,132,9,0,23,11,18,6,0,18,4,68,
...
-define(SCCP_MSG_BIN_1, <<17,129,15,41,3,14,0,11,18,7,0,17,4,100,7,8,0,48,2,24,
                          11,212,73,5,68,161,0,161,173,42,27,37,0,100,18,83,111,64,22,
                          15,23,22,17,65,11,18,6,0,17,4,100,39,147,0,16,0>>).

-define(SCCP_MSG_DEC_1, {sccp_msg,17,
                         [{protocol_class,{1,8}},
                          {hop_counter,15},
                          {called_party_addr,
...
reencode_test() ->
    {ok, Parsed} = ossie_sccp_codec:parse_sccp_msg(?SCCP_MSG_BIN_1),
    ?assertEqual(?SCCP_MSG_DEC_1, Parsed),
    Encoded = ossie_sccp_codec:encode_sccp_msg(?SCCP_MSG_DEC_1),
    {ok, Parsed1} = ossie_sccp_codec:parse_sccp_msg(Encoded),
    ?assertEqual(?SCCP_MSG_DEC_1, Parsed1).
